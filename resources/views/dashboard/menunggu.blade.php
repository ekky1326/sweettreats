        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">
                        <i class="fa fa-hourglass-half mr-2" style="color:#f59e0b"></i>
                        Menunggu Konfirmasi
                    </h4>
                </div>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            @forelse ($reservations as $res)
                                ...
                                <tr id="row-{{ $res->id }}">
                                    <td>{{ $res->date ? $res->date->format('d/m/Y') : '-' }}</td>
                                    ...
                                    <td nowrap>
                                        ...
                                        <button class="quick-btn text-white" style="background:#7c3aed"
                                            onclick="quickStatus('{{ $res->id }}','waitlist')">
                                            <i class="fa fa-list-ol"></i> WL
                                        </button>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center text-muted py-4">
                                        <i class="fa fa-check-double fa-2x mb-2 d-block" style="color:#f59e0b"></i>
